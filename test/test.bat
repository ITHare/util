...
@ECHO OFF
ECHO EXPECT C4018 WARNINGS in the next compile
cl /std:c++latest /EHsc /W3 /DWARNINGS_EXPECTED test.cpp
...
cl /std:c++latest /EHsc /W3 /WX test.cpp
IF NOT ERRORLEVEL 1 GOTO LABEL3
EXIT /B
:LABEL3
test.exe
IF NOT ERRORLEVEL 1 GOTO LABEL4
EXIT /B
:LABEL4
ECHO OK
